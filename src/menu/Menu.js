  ...
  return (
    <Fragment>
      <div className={classes.menu} id="menu">
        ...
        <div className={classes.note}>***You will be contacted immediately after the order has been placed and you will be informed of your delivery cost based on your location***</div>
